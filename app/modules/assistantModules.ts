...
export const prepareUploadFile = async (
  ...
  if (file.type.startsWith("image/")) {
    ...
    const uploadedFile: UploadedFileResponse =
      await uploadFile(descriptionFile);
    setStatusMessage(
...
export const initializeAssistant = async (
  ...
  console.log(
    "Assistant created successfully. Assistant ID:",
...
export const createChatThread = async (
  ...
  console.log(
    "Chat thread created successfully. Thread ID:",
    threadData.threadId,
  );
 ...
 */
export const runChatAssistant = async (
  assistantId: string,
  threadId: string,
): Promise<string | null> => {
